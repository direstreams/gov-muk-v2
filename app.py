...
def search():
    ...
    catalogue = [
        ...
        ("Immigration and citizenship", "Check fictional entry guidance and citizenship steps.", url_for("immigration"), "immigration visa passport citizenship roblox"),
...
def immigration(): return render_template("immigration.html")
