...
def init_db():
    ...
    if db.execute("SELECT COUNT(*) FROM petitions").fetchone()[0] == 0:
        ...
        db.execute(
            ...
            ("Deport Fudgy", "This petition calls on the Government of MUK to consider the deportation of Fudgy under applicable fictional roleplay procedures.", "open", now),
        )
